...
- **Experimental:**
  - The work-in-progress `dist-nix` tries to provide cross-distro support. For distros using relatively old packages like Debian, this is almost the only way to install illogical-impulse. See [#2382](https://github.com/end-4/dots-hyprland/discussions/2382) to have a try.
:::
