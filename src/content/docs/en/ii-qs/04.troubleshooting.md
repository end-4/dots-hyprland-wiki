...
However if the PKGBUILDs are on AUR, if stick to a same installation process, this user will have to download PKGBUILDs, modify them and upload them to AUR with a new name... What if many users are doing this altogether? That's just unacceptable.
