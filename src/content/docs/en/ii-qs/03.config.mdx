...
To change the scale of everything on your screen(s), see [Monitors - Hyprland wiki](https://wiki.hypr.land/Configuring/Monitors/)

Alternatively, for a GUI, you can use `nwg-look`. It should work out of the box with these dotfiles.
...
Edit `~/.config/hypr/custom/env.conf` to include the following line. You'll need to restart Hyprland (by relogging)
