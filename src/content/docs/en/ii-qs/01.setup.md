...
- **Officially supported:**
  - Arch Linux
    - [clsty](https://github.com/clsty)(the main developer of install scripts) uses and recommends Arch Linux: "The vanilla Arch Linux just works. EndeavourOS is also OK because it's using almost (except [this one](https://github.com/endeavouros-team/repo)) the same package repos as Arch Linux."
  - EndeavourOS
