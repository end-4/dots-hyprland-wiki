...
- **Supported:**
  ...
  - Other Arch-based distros are only partially supported, especially if they use a different package repo (like CachyOS, Manjaro).
...
Make a choice between the two below, then follow the prompts. Choice 1 is a wrapper for Choice 2, but understandably you might not be comfortable with piping an online script directly into your shell. Additionally, regardless of your choice, you are encouraged to read and understand the latter, as it is the very basics an [Arch Linux + Hyprland] user should know.
