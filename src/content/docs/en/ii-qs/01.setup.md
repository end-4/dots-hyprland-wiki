...
- Choice 1 is a wrapper for Choice 2, but understandably you might not be comfortable with piping an online script directly into your shell.
- Additionally, regardless of your choice, you are encouraged to read and understand the latter, as it is the very basics a Hyprland user should know.
:::

<Tabs>
<TabItem label="Choice 1">
**Choice 1**: The lazy, enraging way
```bash
bash <(curl -s https://ii.clsty.link/setup)
```

By default it clones the repo to `~/.cache/dots-hyprland`.
...
<TabItem label="Choice 2">
**Choice 2**: The manual-ish, you-know-what-you're-doing way
```bash
