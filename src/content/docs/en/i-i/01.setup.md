...
- See also https://github.com/end-4/dots-hyprland/issues/238
...
- If you want Qt theming to work, run the following commands and select KVantum in the windows that pop up:
```sh
kcmshell6 kcm_style
