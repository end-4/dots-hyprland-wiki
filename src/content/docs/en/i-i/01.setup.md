...
- See https://github.com/end-4/dots-hyprland/discussions/840
...
- Other notification daemons like `dunst` and `mako` may come with your distro's customizations and can interfere with AGS if they somehow start first. It is recommended to uninstall them if you don't use them somewhere else.
## Optional stuff
### Extra configs
