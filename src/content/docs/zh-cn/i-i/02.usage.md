...
你可以自行查看这些文件，并将 [Hyprland Wiki](https://wiki.hyprland.org/) 作为主要的参考。

:::caution
请注意 `rules.conf`，因为它可能会意外地覆盖你的配置，就像 [#259](https://github.com/end-4/dots-hyprland/issues/259) 提到的那样。
