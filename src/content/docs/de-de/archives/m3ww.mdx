...
:::danger[Warnung]
Dieses Konfigurationsset wird nicht mehr gepflegt. Wir empfehlen, es nicht zu verwenden.
:::

# Beschreibung
- Das neueste Eww-basierte Setup, das dem Stil von [Material Design 3](https://m3.material.io/) folgt
# Installation
