...
:::danger[Warnung]
Diese Konfigurationssets werden nicht mehr gepflegt. Wir empfehlen, sie nicht zu verwenden.
:::

# Beschreibung
Mehrere Konfigurationssets, darunter `windoes`, `hybrid` und `NovelKnock`.
# Installation
