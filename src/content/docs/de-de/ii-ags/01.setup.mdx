...
Obwohl sie noch funktionieren kann, musst du Probleme selber lösen.
...
-  Dies bietet nur **Benutzer-Level-Anpassung**. Die Installation von GNOME kann grundlegende Systemkomponenten wie Netzwerk, Bluetooth etc. enthalten, aber es wird erwartet, dass du diese selbst bereits eingerichtet hast
