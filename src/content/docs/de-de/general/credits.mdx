...
## Entwickler
- [end_4](https://github.com/end-4): Repo-Besitzer und Autor.
  - Hat mehrere Varianten von Ricing entwickelt, was den Hauptteil dieses Projekts ausmacht.
    - Wartet jetzt die aktuellste Variante, also illogical-impulse auf Quickshell.
  - Aufgaben wie Bearbeitung von Issues/PRs/Discussions, Aktualisierung/Übersetzung der Dokumentation usw.
  - Andere Dinge wie Erstellen des illogical-impulse-Logos usw.
  - Seit Januar 2023 bis heute.
...
:::tip[Danke]{icon="heart"}
Dieses Projekt hätte ohne die folgenden Personen nicht seinen aktuellen Stand erreicht.
:::

**Die engagierten Entwickler:** _Siehe vorherigen Abschnitt._
